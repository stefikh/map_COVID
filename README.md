...
В файле *requirements.txt* находятся названия необходимых библиотек, вы можете их установить с помощью команды
**python -m pip install -r requirements.txt** или команды **pip install -r requirements.txt** в консоли.
